...
#define MAX_KEYWORD_STRING_LTH 6																// maksymalna dlugosc komendy.
#define MAX_KEYWORD_NR 2																				// maksymalna dopuszczalna ilosc slow kluczowych.
...
typedef enum			tKeywordCode			{CALLIB, GOTO}							tKeywordCode;	
