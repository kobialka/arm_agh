...
void Timer0Interrupts_Init(unsigned int uiPeriod,  tFunctionPointer ptrInterruptFunction)	 // microseconds
{
...
void Timer1Interrupts_Init(unsigned int uiPeriod, tFunctionPointer ptrInterruptFunction)
{
